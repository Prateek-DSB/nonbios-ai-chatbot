...
const submit=(v)=>{v.preventDefault();sE('');sL(true);if({'abc1':'xyz1','abc2':'xyz2','abc3':'xyz3','abc4':'xyz4','abc5':'xyz5'}[u]===p){localStorage.setItem('nonbios_user',u);setTimeout(()=>r.push('/portal'),100);}else{sE('Invalid');sL(false);}};
